...
total_current_sp_custom_field_id = '70e0a4f0-3631-46af-8f02-561706fb3761'
...
if 'subtasks' in task_details:
    ...
    for subtask in subtasks:
        ...
        total_current_sp += progress_spoopoint

        print(f"進捗SP: {progress_spoopoint}")

    print(f"total_current_sp: {total_current_sp}")

else:
    print("No subtasks found or 'subtasks' key not present in response.")

update_url = f'https://api.clickup.com/api/v2/task/{task_id}/field/{total_current_sp_custom_field_id}'

# 更新するデータ
data = {
    "value": total_current_sp
}
